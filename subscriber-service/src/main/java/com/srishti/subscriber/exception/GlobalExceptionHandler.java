package com.srishti.subscriber.exception;

import com.srishti.subscriber.dto.response.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({
            SubscriberAlreadyExistException.class
    })
    ...
    @ExceptionHandler({
            SubscriberRegistrationException.class
    })
